...
CREATE TABLE Tipo_Usuario(
	...
	Titulo VARCHAR (255) UNIQUE NOT NULL -- UNIQUE NÃO PERMITE INSERIR DOIS DADOS IGUAIS
);
...
CREATE TABLE Evento(
	...
	Titulo VARCHAR (255) UNIQUE NOT NULL, -- UNIQUE NÃO PERMITE INSERIR DOIS DADOS IGUAIS
	Acesso_livre BIT DEFAULT(1) NOT NULL, -- BIT = 1 = true = acesso livre. Valor default = 1
...
CREATE TABLE Presenca(
	...
	Presemca_status VARCHAR (255) UNIQUE NOT NULL, -- UNIQUE NÃO PERMITE INSERIR DOIS DADOS IGUAIS
